...
Scenario Outline: Internal links are transformed
  ...
  Examples:
    ...
    # Slideshow link is converted into a regular link with slide0 added, data-asset-type attribute is added and title attribute is preserved:
    | <p><a href="/FT/Content/Companies/Stories/Live/Copy%20of%20PlainSlideshow.gallery.xml?uuid=5e231aca-a42b-11e1-a701-00144feabdc0" type="slideshow" dtxInsert="slideshow" title="Title text" target="_blank"><DIHeadlineCopy>Link with just suffix</DIHeadlineCopy></a></p> | <p><a data-asset-type="slideshow" href="http://www.ft.com/cms/s/5e231aca-a42b-11e1-a701-00144feabdc0.html#slide0" title="Title text"/></p> |
    # Slideshow link is converted into a regular link with slide0 added, data-asset-type attribute is added and alt attribute is dropped:
    ...
    # Slideshow link is converted into a regular link with #slide0 added, data-asset-type attribute is added and query parameter is preserved:
    ...
    # Slideshow link is converted into a regular link with #slide0 added, data-asset-type attribute is added and query parameters are preserved:
    ...
    # Slideshow link is converted into a regular link with slide0 added, data-asset-type attribute is added and empty title attribute is removed:
