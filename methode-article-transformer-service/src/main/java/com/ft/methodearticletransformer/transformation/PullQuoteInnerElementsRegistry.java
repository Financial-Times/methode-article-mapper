...
public class PullQuoteInnerElementsRegistry extends XMLEventHandlerRegistry {
	...
	public PullQuoteInnerElementsRegistry(MethodeBodyTransformationXMLEventHandlerRegistry handlerRegistry) {
		this.handlerRegistry = handlerRegistry;

		this.registerStartAndEndElementEventHandlerWrapper(new StripXMLEventHandler(),
				"p");
	}
