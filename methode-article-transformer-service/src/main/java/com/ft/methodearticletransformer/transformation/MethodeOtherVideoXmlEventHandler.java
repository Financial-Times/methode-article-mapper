...
//
//
//            StartElement aStartElementEvent = new StartElementEventImpl(QName.valueOf("a"), attributesToAdd, null, null);
//            StartElement aEndElementEvent = new StartElement(QName.valueOf("a"));
//
