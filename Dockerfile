...
CMD java -Ddw.server.applicationConnectors[0].port=8080 \
     ...
     -Ddw.sourceApi.endpointConfiguration.primaryNodes=$HOSTNAME:8080:8080 \
     -Ddw.semanticContentStoreReader.endpointConfiguration.primaryNodes=$HOSTNAME:8080:8080 \
