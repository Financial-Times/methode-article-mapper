...
public class BlockquoteXMLEventHandler extends BaseXMLEventHandler {
  ...
  public void handleStartElementEvent(
    ...
    BlockquoteData blockquoteData =
        blockquoteXMLParser.parseElementData(event, xmlEventReader, bodyProcessingContext);
    ...
    if (!paragraphs.isEmpty()) {
      ...
      if (bodyProcessingContext instanceof TransactionIdBodyProcessingContext) {
        TransactionIdBodyProcessingContext ctx =
            (TransactionIdBodyProcessingContext) bodyProcessingContext;
        LOGGER.warn(
            "Removing blockquote because it does not have any valid paragraph tags. transactionId {}",
