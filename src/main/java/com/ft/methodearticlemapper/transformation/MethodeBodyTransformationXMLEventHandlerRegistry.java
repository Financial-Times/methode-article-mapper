...
public class MethodeBodyTransformationXMLEventHandlerRegistry extends XMLEventHandlerRegistry {
    ...
    public MethodeBodyTransformationXMLEventHandlerRegistry(final VideoMatcher videoMatcher,
            final InteractiveGraphicsMatcher interactiveGraphicsMatcher, String ftContentUrlTemplate) {
        ...
        registerStartAndEndElementEventHandler(new SlideshowEventHandler(new SlideshowXMLParser(), new LinkTagXMLEventHandler("title", "alt"), caselessMatcher("type", "slideshow"), ftContentUrlTemplate), "a");
