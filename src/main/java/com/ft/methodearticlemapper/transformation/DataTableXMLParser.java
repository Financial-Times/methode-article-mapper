...
public class DataTableXMLParser extends BaseXMLParser<DataTableData>
    implements XmlParser<DataTableData> {
    ...
    if (isElementNamed(nextStartElement.getName(), START_ELEMENT_NAME)) {
      dataTableData.setBody(
          transformRawContentToStructuredFormat(
              parseRawContent(START_ELEMENT_NAME, xmlEventReader, nextStartElement),
  ...
  public void transformFieldContentToStructuredFormat(
      DataTableData dataTableData, BodyProcessingContext bodyProcessingContext) {
