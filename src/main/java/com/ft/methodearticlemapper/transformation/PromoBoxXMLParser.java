...
public class PromoBoxXMLParser extends BaseXMLParser<PromoBoxData>
    implements XmlParser<PromoBoxData> {
  ...
  public void transformFieldContentToStructuredFormat(
      PromoBoxData promoBoxData, BodyProcessingContext bodyProcessingContext) {
