...
public class StripByPredefinedAttributesAndValuesEventHandlerRegistry
    extends XMLEventHandlerRegistry {

  public StripByPredefinedAttributesAndValuesEventHandlerRegistry() {
    // Default is to check all tags for channel attribute if there is no channel the element is
    // retained
    ...
    registerDefaultEventHandler(
        retainElementAndContentsIfValueMatches(
            channelAttributes,
            stripElementsAndContentsIfValueMatches(classAttributes, retainXMLEventHandler)));
  ...
  public static ElementNameAndAttributeValueMatcher attributeNameMatchesAndValueIsInList(
      final String attributeName,
      final List<String> attributesValuesList,
      final boolean attributeValueMatches) {
    return new ElementNameAndAttributeValueMatcher() {

      @Override
      public boolean matchesElementNameAndAttributeValueCriteria(
  ...
  public XMLEventHandler retainElementAndContentsIfValueMatches(
      List<String> channelAttributes, XMLEventHandler retainXMLEventHandler) {
    return new StripByPredefinedAttributesAndValuesEventHandler(
        retainXMLEventHandler,
        attributeNameMatchesAndValueIsInList("channel", channelAttributes, true),
        channelAttributes);
  }

  public XMLEventHandler stripElementsAndContentsIfValueMatches(
      List<String> classAttributes, XMLEventHandler retainXMLEventHandler) {
    return new StripByPredefinedAttributesAndValuesEventHandler(
        retainXMLEventHandler,
        attributeNameMatchesAndValueIsInList("class", classAttributes, false),
        classAttributes);
  }
}
