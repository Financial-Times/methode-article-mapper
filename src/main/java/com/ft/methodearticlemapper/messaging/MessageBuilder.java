...
public class MessageBuilder {
  ...
  public MessageBuilder(
      ...
      Map<String, String> contentTypeMappings) {
  ...
  Message buildMessage(Content content, Map<String, String> headers) {
    MessageBody msgBody =
        new MessageBody(
            ...
            RFC3339_FMT.format(
                OffsetDateTime.ofInstant(content.getLastModified().toInstant(), UTC)));
    return buildMessage(
        content.getUuid(), content.getPublishReference(), headers, msgBody, content.getType());
  }

  Message buildMessageForDeletedMethodeContent(
      String uuid,
  ...
  public static class MessageBody {
    ...
    MessageBody(
        @JsonProperty("payload") Content payload,
