...
public class MethodeArticleMapperApplication
    extends Application<MethodeArticleMapperConfiguration> {
  ...
  @Override
  public void run(
      final MethodeArticleMapperConfiguration configuration, final Environment environment)
      throws Exception {
    ...
    environment
        ...
        .addMappingForUrlPatterns(
            EnumSet.of(DispatcherType.REQUEST), true, "/content-transform/*", "/map");
    ...
    if (configuration.isDocumentStoreApiEnabled()) {
      DocumentStoreApiConfiguration documentStoreApiConfiguration =
          configuration.getDocumentStoreApiConfiguration();
      EndpointConfiguration documentStoreApiEndpointConfiguration =
          documentStoreApiConfiguration.getEndpointConfiguration();
      documentStoreApiClient =
          configureResilientClient(
              environment,
              documentStoreApiEndpointConfiguration,
              documentStoreApiConfiguration.getConnectionConfig());

      UriBuilder documentStoreApiBuilder =
          UriBuilder.fromPath(documentStoreApiEndpointConfiguration.getPath())
              .scheme("http")
              .host(documentStoreApiEndpointConfiguration.getHost())
              .port(documentStoreApiEndpointConfiguration.getPort());
      documentStoreUri = documentStoreApiBuilder.build();

      healthchecks.add(
          buildDocumentStoreAPIHealthCheck(
              documentStoreApiClient, documentStoreApiEndpointConfiguration));
    }

    Client concordanceApiClient = null;
    URI concordanceUri = null;
    if (configuration.isConcordanceApiEnabled()) {
      ConcordanceApiConfiguration concordanceApiConfiguration =
          configuration.getConcordanceApiConfiguration();
      EndpointConfiguration concordanceApiEndpointConfiguration =
          concordanceApiConfiguration.getEndpointConfiguration();
      concordanceApiClient =
          configureResilientClient(
              environment,
              concordanceApiEndpointConfiguration,
              concordanceApiConfiguration.getConnectionConfiguration());
      UriBuilder concordanceApiBuilder =
          UriBuilder.fromPath(concordanceApiEndpointConfiguration.getPath())
              .scheme("http")
              .host(concordanceApiEndpointConfiguration.getHost())
              .port(concordanceApiEndpointConfiguration.getPort());
      concordanceUri = concordanceApiBuilder.build();

      healthchecks.add(
          buildConcordanceAPIHealthCheck(
              concordanceApiClient, concordanceApiEndpointConfiguration));
    }

    EomFile.setAdditionalMappings(configuration.getAdditionalNativeContentProperties());

    EomFileProcessor eomFileProcessor =
    ...
    if (configuration.isMessagingEndpointEnabled()) {
      ...
      Client producerClient =
          getMessagingClient(
              environment, producerConfig.getJerseyClientConfiguration(), "producer-client");
      ...
      MessageProducingArticleMapper msgProducingListMapper =
          new MessageProducingArticleMapper(
              getMessageBuilder(configuration, environment), producer, eomFileProcessor);
      ...
      healthchecks.add(
          registerListener(
              ...
              consumerConfig,
              getMessagingClient(
                  environment, consumerConfig.getJerseyClientConfiguration(), "consumer-client")));
    }
    ...
    environment
        ...
        .register(
            new PostContentToTransformResource(
                eomFileProcessor,
                configuration.getLastModifiedSource(),
                configuration.getTxIdSource(),
  ...
  private void registerHealthChecks(
      Environment environment, List<AdvancedHealthCheck> advancedHealthChecks) {
  ...
  private AdvancedHealthCheck buildConcordanceAPIHealthCheck(
  ...
  private AdvancedHealthCheck buildDocumentStoreAPIHealthCheck(
  ...
  private MessageBuilder getMessageBuilder(
      MethodeArticleMapperConfiguration configuration, Environment environment) {
  ...
  private Client getMessagingClient(
      Environment environment, JerseyClientConfiguration jerseyConfig, String name) {
  ...
  protected AdvancedHealthCheck registerListener(
      Environment environment,
      MessageListener listener,
  ...
  private AdvancedHealthCheck buildProducerHealthCheck(
      Environment environment,
  ...
  private AdvancedHealthCheck buildConsumerHealthCheck(
      Environment environment,
      ConsumerConfiguration config,
