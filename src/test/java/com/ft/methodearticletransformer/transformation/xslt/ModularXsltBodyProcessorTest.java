...
public class ModularXsltBodyProcessorTest {
    ...
    public static final String REPLACE_B_TEMPLATE = "<xsl:stylesheet version=\"1.0\" xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\">\n" +
    ...
    public static final XsltFile CORRECT_B_TAG = new XsltFile("correctBTag", String.format(REPLACE_B_TEMPLATE, "strong", "strong"));

    public static final XsltFile HUGE_B_TAG = new XsltFile("hugeBTag", String.format(REPLACE_B_TEMPLATE, "HUGE", "HUGE"));

    public static final XsltFile WACKY_B_TAG = new XsltFile("wackyBTag", String.format(REPLACE_B_TEMPLATE, "wacky", "wacky"));
    ...
    public void shouldNotAffectWhitespaceBetweenElementsByDefault() {
        ...
        String result = identityTransformer.process(exampleDoc, new DefaultTransactionIdBodyProcessingContext("test"));
    ...
    @Test
     public void shouldCombineAdditionalXsltAndKeepDefaultRules() {
        ...
        String expectedDoc= "<body><strong>BOLD</strong><img/>" + WHITESPACE + "<p>Some Text</p></body>";

        String result = bTagTransformer.process(exampleDoc, new DefaultTransactionIdBodyProcessingContext("test"));
    ...
    public void shouldCombineMultipleXsltAndTakeMatchingTemplateListedFirst() {
        ...
        ModularXsltBodyProcessor bTagTransformer = new ModularXsltBodyProcessor(WACKY_B_TAG, HUGE_B_TAG, CORRECT_B_TAG);
