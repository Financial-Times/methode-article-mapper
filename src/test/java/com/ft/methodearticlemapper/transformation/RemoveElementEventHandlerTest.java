...
import static com.ft.methodearticlemapper.transformation.MethodeBodyTransformationXMLEventHandlerRegistry.attributeNameMatcher;
import static com.ft.methodearticlemapper.transformation.MethodeBodyTransformationXMLEventHandlerRegistry.caselessMatcher;
...
public class RemoveElementEventHandlerTest extends BaseXMLEventHandlerTest {
  ...
  public void setup() throws Exception {
    eventHandler =
        new RemoveElementEventHandler(fallbackEventHandler, attributeNameMatcher("channel"));
  ...
  public void testRemoveUnwantedSlideshow() throws Exception {
    ...
    final RemoveElementEventHandler unit =
        new RemoveElementEventHandler(fallback, caselessMatcher("type", "slideshow"));
    final XMLEventHandlerRegistry registry =
    ...
    final String xml =
        "<p><a type=\"slideshow\" href=\"http://example.com/\">Some content</a> and some unlinked content</p>";
  ...
  public void testRetainWantedAnchor() throws Exception {
    ...
    final StAXTransformingBodyProcessor processor = new StAXTransformingBodyProcessor(registry);
    final String xml =
        "<p><a type=\"leopard\" href=\"http://example.com/\">Some content</a> and some unlinked content</p>";
    final String actual = processor.process(xml, null);
    assertEquals(xml, actual);
  }

  @Test
  public void shouldRemoveStartTagAndContentsUpToMatchingEndTagIfStrikeoutAttributePresent()
      throws Exception {
    ...
    when(mockXmlEventReader.nextEvent())
        .thenReturn(
            getCharacters("Some text in "),
            getStartElement("i"),
            getCharacters("italics"),
            getEndElement("i"),
            getCharacters(" and some note"),
            getEndElement("p"));
    when(mockXmlEventReader.peek())
        .thenReturn(
            getCharacters("Some text in "),
            getStartElement("i"),
            getCharacters("italics"),
