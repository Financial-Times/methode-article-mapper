...
public class InlineImageXmlEventHandlerTest extends BaseXMLEventHandlerTest {
  ...
  public void testTransformStartElementTag() throws Exception {
    ...
    attributesMap.put(
        FILE_REF_ATTRIBUTE,
        "/FT/Graphics/Online/Master_2048x1152/2014/04/MAS_CatalansDemo.jpg?uuid=" + UUID);
    StartElement webInlinePictureStartElementTag =
        getStartElementWithAttributes("web-inline-picture", attributesMap);

    eventHandler.handleStartElementEvent(
        webInlinePictureStartElementTag,
        mockXmlEventReader,
        mockEventWriter,
    ...
    expectedAttributes.put(
        "id", DeriveUUID.with(IMAGE_SET).from(java.util.UUID.fromString(UUID)).toString());
  ...
  public void testTransformStartElementShouldSkipInvalidUuidInFileReference() throws Exception {
    ...
    attributesMap.put(
        FILE_REF_ATTRIBUTE,
        "/FT/Graphics/Online/Master_2048x1152/2014/04/MAS_CatalansDemo.jpg?uuid=invalidUuid");
  ...
  public void testTransformStartElementShouldSkipInvalidFileReference() throws Exception {
    ...
    attributesMap.put(
        FILE_REF_ATTRIBUTE,
        "/FT/Graphics/Online/Master_2048x1152/2014/04/MAS_CatalansDemo.jpg?" + UUID);
  ...
  public void testTransformStartElementShouldSkipMissingFileReference() throws Exception {
    StartElement webInlinePictureStartElementTag =
        getStartElementWithAttributes("web-inline-picture", ImmutableMap.<String, String>of());
  ...
  public void testTransformEndElement() throws Exception {
    ...
    eventHandler.handleEndElementEvent(
        webInlinePictureEndElementTag, mockXmlEventReader, mockEventWriter);
        ...
        new XMLEventHandlerRegistry() {
          {
            ...
            this.registerStartAndEndElementEventHandler(
                inlineImageXmlEventHandler, "web-inline-picture");
          }
        };
    ...
    final String inputXml =
        String.format(
            "<web-inline-picture "
                ...
                + "arbitrary text</web-inline-picture>",
            UUID);
    final String actual = processor.process(inputXml, null);

    String expectedXml =
        String.format(
            "<content id=\"%s\" type=\"%s\" data-embedded=\"true\"></content>",
            DeriveUUID.with(IMAGE_SET).from(java.util.UUID.fromString(UUID)).toString(),
            IMAGE_SET_TYPE);
