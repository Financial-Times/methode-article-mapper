...
public class DynamicContentXMLEventHandlerTest extends BaseXMLEventHandlerTest {
  ...
  @Mock private DynamicContentXMLParser mockDynamicContentXMLParser;
  @Mock private DynamicContentData mockDynamicContentData;
  @Mock private XMLEventReader mockXMLEventReader;
  @Mock private BodyWriter mockBodyWriter;
  @Mock private MappedDataBodyProcessingContext mockMappedDataBodyProcessingContext;
  ...
  public void shouldNotWriteDynamicContentIfRequiredDataIsMissing() throws Exception {
    ...
    when(mockDynamicContentXMLParser.parseElementData(
            startElement, mockXMLEventReader, mockMappedDataBodyProcessingContext))
        .thenReturn(mockDynamicContentData);

    dynamicContentXMLEventHandler.handleStartElementEvent(
        startElement, mockXMLEventReader, mockBodyWriter, mockMappedDataBodyProcessingContext);
  ...
  @Test
  public void shouldWriteTransformedDynamicContentWhenWrongBodyProcessingContextInstanceType()
      throws Exception {
    StartElement startElement = getStartElement(START_ELEMENT_TAG);
    HashMap<String, String> attributes = new HashMap<>();
    attributes.put("type", "http://www.ft.com/ontology/content/DynamicContent");
