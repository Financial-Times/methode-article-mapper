...
import static com.ft.methodearticlemapper.transformation.StripByPredefinedAttributesAndValuesEventHandlerRegistry.attributeNameMatchesAndValueIsInList;
...
public class StripByPredefinedAttributesAndValuesEventHandlerTest extends BaseXMLEventHandlerTest {
  ...
  public void setup() throws Exception {
    ...
    eventHandler =
        new StripByPredefinedAttributesAndValuesEventHandler(
            fallbackEventHandler,
            attributeNameMatchesAndValueIsInList("channel", channelAttributes, true),
            channelAttributes);
  }
  ...
  public void shouldUseFallbackHandlerForStartTagIfAttributesDoNotMatch() throws Exception {
    ...
    eventHandler.handleStartElementEvent(
        startElement, mockXmlEventReader, eventWriter, mockBodyProcessingContext);
    verify(fallbackEventHandler)
  ...
  @Test
  public void shouldIgnoreStartTagAndContentsUpToMatchingEndTagIfChannelAttributesAreEmpty()
      throws Exception {
    StartElement startElement =
        getCompactStartElement(
            "<span channel=\"\">Some text in <i>italics</i> and some not</span>", "span");
    eventHandler.handleStartElementEvent(
        startElement, mockXmlEventReader, eventWriter, mockBodyProcessingContext);
  ...
  @Test
  public void
      shouldIgnoreStartTagAndContentsUpToMatchingEndTagIfChannelAttributesDoNotMatchRetainableValues()
          throws Exception {
    StartElement startElement =
        getCompactStartElement(
            "<span channel=\"!\">Some text in <i>italics</i> and some not</span>", "span");
  ...
  @Test
  public void shouldRetainStartTagAndContentsUpToMatchingEndTagIfChannelAttributesIsFTcom()
      throws Exception {
    StartElement startElement =
        getCompactStartElement(
            "<b channel=\"FTcom\">Some text in <i>italics</i> and some not</b>", "b");
    eventHandler.handleStartElementEvent(
        startElement, mockXmlEventReader, eventWriter, mockBodyProcessingContext);
    verify(fallbackEventHandler)
        .handleStartElementEvent(
  ...
  @Test
  public void
      shouldRetainStartTagAndContentsUpToMatchingEndTagIfChannelAttributesIsNotFinancialTimes()
          throws Exception {
    StartElement startElement =
        getCompactStartElement(
            "<table channel=\"!Financial Times\"><tr><td></td></tr></table>", "table");
    eventHandler.handleStartElementEvent(
        startElement, mockXmlEventReader, eventWriter, mockBodyProcessingContext);
    verify(fallbackEventHandler)
        .handleStartElementEvent(
  ...
  public void shouldRetainStartTagAndContentsUpToMatchingEndTagIfContentIsVideo() throws Exception {
    StartElement startElement =
        getCompactStartElement(
            "<p channel=\"FTcom\"><iframe src=\"http://www.youtube.com/watch?v=wDcAQrgn50o\"></iframe></p>\"",
            "p");
    eventHandler.handleStartElementEvent(
        startElement, mockXmlEventReader, eventWriter, mockBodyProcessingContext);
    verify(fallbackEventHandler)
