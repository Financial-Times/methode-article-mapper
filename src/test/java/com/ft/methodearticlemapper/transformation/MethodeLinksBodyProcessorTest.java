...
public class MethodeLinksBodyProcessorTest {
  ...
  @Mock private WebResource.Builder builder;
  @Mock private ClientHandlerException clientHandlerException;
  @Mock private ClientResponse clientResponse;
  @Mock private BodyProcessingContext bodyProcessingContext;
  ...
  public void setup() throws Exception {
    bodyProcessor =
        new MethodeLinksBodyProcessor(
            documentStoreApiClient, new URI("www.document-store-api.com"), CANONICAL_URL_TEMPLATE);
  ...
  public void shouldReturnUnchangedBodyIfBodyIsNull() {
    String processedBody =
        bodyProcessor.process(null, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void shouldReturnUnchangedBodyIfBodyIsEmpty() {
    String processedBody =
        bodyProcessor.process("", new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void shouldThrowBodyProcessingExceptionWhenTransactionIdIsNull() {
    ...
    when(clientResponse.getEntity(String.class))
        .thenReturn("[{\"uuid\":\"" + uuid + "\", \"type\": \"Article\"}]");

    String body =
        "<body><a href=\"http://www.url.com/"
            + uuid
            + "\" title=\"Some absurd text here\"> Link Text</a></body>";
  ...
  public void shouldThrowBodyProcessingExceptionWhenDocumentStoreUnavailable() {
    ...
    String body =
        "<body><a href=\"" + uuid + "\" title=\"Some absurd text here\"> Link Text</a></body>";
    ...
    assertThat(
        ...
        is(
            identicalXmlTo(
                "<body><content id=\""
                    + uuid
                    + "\" title=\"Some absurd text here\" type=\""
                    + MethodeLinksBodyProcessor.BASE_CONTENT_TYPE
                    + "Article\">Link Text</content></body>")));
  }
        ...
        is(
            identicalXmlTo(
                "<body><content id=\""
                    + uuid
                    + "\" title=\"Some absurd text here\" type=\""
                    + MethodeLinksBodyProcessor.DEFAULT_CONTENT_TYPE
                    + "\">Link Text</content></body>")));
  }
  ...
  public void shouldReplaceNodeWhenHrefContainsMethodePathWithUuidPresentInDocumentStore() {
    ...
    String body =
        "<body><a href=\"/Content/2007/Path/To/Methode/Article.xml?uuid="
            + uuid
            + "\" title=\"Some absurd text here\">Link Text</a></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void shouldNotReplaceNodeWhenItsALinkThatWillNotBeInTheDocumentStore() {
    String body =
        "<body><a href=\"http://www.ft.com/cms/s/"
            + uuid
            + ".html\" title=\"Some absurd text here\"> Link Text</a></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
    ...
    assertThat(
        ...
        is(
            identicalXmlTo(
                "<body><a href=\"https://www.ft.com/content/"
                    + uuid
                    + "\" title=\"Some absurd text here\"> Link Text</a></body>")));
  }
  ...
  @Test
  public void
      shouldReplaceHrefWithCanonicalUrlTemplateWhenItsALinkThatWillNotBeInTheDocumentStore() {
    String body =
        "<body><a href=\"http://www.ft.com/intl/cms/s/"
            + uuid
            + ".html\" title=\"Some absurd text here\"> Link Text</a></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  @Test
  public void
      shouldConvertMethodeLinksWhenItsALinkThatWillNotBeInTheDocumentStoreToFullFledgedWebsiteLinks() {
    String body =
        "<body><a href=\"/FT Production/Slideshows/gallery.xml;uuid="
            + uuid
            + "\" title=\"Some absurd text here\"> Link Text</a></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void shouldPreserveExternalLinksWithUuidThatWillNotBePresentDocumentStore() {
    String body =
        "<body><a href=\"http://www.external.com/"
            + uuid
            + "\" title=\"Some absurd text here\"> Link Text</a></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void shouldRemoveTypeAttributeFromInternalLinks() {
    String body =
        "<body><a href=\"http://www.ft.com/content/"
            + uuid
            + "\" type=\"some-type\"> Link Text</a></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void shouldRemoveNodeIfATagHasHrefThatStartsWithAnchorPrefix() {
    String body =
        "<body><a href=\"#http://www.ft.com/content/add666f2-cd78-11e4-a15a-00144feab7de\" title=\"Some absurd text here\">Link Text</a></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void shouldRemoveNodeIfATagHasNoHrefAttributeWhilePreservingAllItsChildren() {
    String body =
        "<body><a title=\"Some absurd text here\"><strong>first child</strong> Second child <![CDATA[CDATASection]]></a></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
    ...
    assertThat(
        ...
        is(
            identicalXmlTo(
                "<body><strong>first child</strong> Second child <![CDATA[CDATASection]]></body>")));
  }
  ...
  public void thatWhitespaceOnlyLinksAreRemoved() {
    String body =
        "<body>Foo <a href=\"http://www.ft.com/intl/cms/s/0/12345.html\" title=\"Test link containing only whitespace\">\n</a> bar</body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void thatCommentOnlyLinksAreRemoved() {
    String body =
        "<body><a href=\"http://www.ft.com/intl/cms/s/0/12345.html\" title=\"Test link containing only comments\"><!-- Comment --></a></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void thatEmptyLinksWithDataAttributesArePreserved() {
    String body =
        "<body>Foo <a data-asset-type=\"slideshow\" data-embedded=\"true\" href=\"http://www.ft.com/intl/cms/s/0/12345.html\" title=\"Test link with tag content\"></a> bar</body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void thatWhitespaceAndChildTagsOnlyLinksArePreserved() {
    String body =
        "<body>Foo <a href=\"http://www.ft.com/intl/cms/s/0/12345.html\" title=\"Test link with tag content\"><img src=\"http://localhost/\"/>\n</a> bar</body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void thatEmptyLinksWithinPromoBoxesArePreserved() {
    String body =
        "<body>Foo <promo-box><promo-link><p><a title=\"Test Promo Link\" href=\"http://www.ft.com/cms/s/0/0bdf4bb6-6676-11e4-8bf6-00144feabdc0.html\"/></p></promo-link></promo-box> bar</body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void thatSpaceIsAddedBeforeAfterLinkText() {
    ...
    String body =
        "<body><p>The last time<a href=\""
            + uuid
            + "\">China</a>was the world&#x2019;s largest economy</p></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));

    String expectedBody =
        "<body><p>The last time <content id=\""
            + uuid
            + "\" type=\""
            + MethodeLinksBodyProcessor.BASE_CONTENT_TYPE
            + "Article\">China</content> was the world&#x2019;s largest economy</p></body>";
  ...
  public void thatPunctuationIsExtractedOutsideATag() {
    ...
    String body =
        "<body><p><a href=\"" + uuid + "\">link text!?</a>  Lorem ipsum doler sit amet…</p></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
    ...
    String expectedBody =
        "<body><p><content id=\""
            ...
            + "\" type=\""
            + MethodeLinksBodyProcessor.BASE_CONTENT_TYPE
            + "Article\">link text</content>!?  Lorem ipsum doler sit amet…</p></body>";
  ...
  public void thatPunctuationIsExtractedOutsideATagEmptyParagraphAfter() {
    ...
    String expectedBody =
        "<body><p><content id=\""
            ...
            + "\" type=\""
            + MethodeLinksBodyProcessor.BASE_CONTENT_TYPE
            + "Article\">link text</content>!?</p></body>";
  ...
  public void thatWhitespaceNotRemovedWhenParenthesisPunctuation() {
    ...
    String expectedBody =
        "<body><p><content id=\""
            ...
            + "\" type=\""
            + MethodeLinksBodyProcessor.BASE_CONTENT_TYPE
            + "Article\">link text</content> (some details)</p></body>";
  ...
  public void thatWhitespaceFromLinkTextAreRemoved() {
    ...
    String body =
        "<body><p><a href=\""
            + uuid
            + "\">link text </a>  .  Lorem ipsum doler sit amet…</p></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void thatStreamLinksArePreserved() {
    String body =
        "<body><a href=\"https://www.ft.com/stream/" + uuid + "\">Matteo Salvini</a></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));
  ...
  public void thatVideoLinksAreChangedToContent() {
    String body =
        "<body><a href=\"https://www.ft.com/video/" + uuid + "\">Matteo Salvini</a></body>";
    String processedBody =
        bodyProcessor.process(body, new DefaultTransactionIdBodyProcessingContext(TRANSACTION_ID));

    String expectedBody =
        "<body><a href=\"https://www.ft.com/content/" + uuid + "\">Matteo Salvini</a></body>";
  ...
  public void thatCorrectUUIDisAppendedToConvertedLink() {
    ...
    String expectedBody =
        "<body><a href=\"https://www.ft.com/content/" + uuid + "\">random text</a></body>";
