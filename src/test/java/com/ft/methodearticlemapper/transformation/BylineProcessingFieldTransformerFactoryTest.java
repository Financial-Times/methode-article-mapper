...
public class BylineProcessingFieldTransformerFactoryTest {
  ...
  public void defaultBylineShouldBeReturnedAsEmptyByline() {
    checkTransformation(
        "<byline>By <author-name><?EM-dummyText [Insert author]?></author-name></byline>", "");
  }
  ...
  public void shouldRemoveFinancialTimesChannelText() {
    checkTransformation(
        "By <author-name>Martin <b channel=\"Financial Times\">Rodders</b> Roddam</author-name>",
        "By Martin  Roddam");
  }
  ...
  public void shouldRemoveNotFtComChannelText() {
    checkTransformation(
        "By <author-name>Martin <b channel=\"!FTcom\">Rodders</b> Roddam</author-name>",
        "By Martin  Roddam");
  }
  ...
  public void shouldRemoveNotAnythingChannelText() {
    checkTransformation(
        "By <author-name>Martin <b channel=\"!\">Rodders</b> Roddam</author-name>",
        "By Martin  Roddam");
  }
  ...
  public void notesShouldBeRemoved() {
    checkTransformation(
        "Text with a note <span class=\"@notes\"></span>in the middle",
        "Text with a note in the middle");
  }

  @Test
  public void annotationsShouldBeRemoved() {
    checkTransformation(
        "This is <annotation c=\"roddamm\" cd=\"20150224170716\">A new annotation </annotation>annotated",
        "This is annotated");
  }
  ...
  public void encodedNbspShouldBeReplacedWithSpace() {
    checkTransformation(
        "This is a sentence .", String.format("This is a sentence%s.", String.valueOf('\u00A0')));
  }

  @Test
  public void htmlEntityReferencesShouldBeUnescaped() {
    checkTransformation(
        "This is a sentence&euro;.",
        String.format("This is a sentence%s.", String.valueOf('\u20AC')));
  }
  ...
  private void checkTransformation(String originalByline, String expectedTransformedByline) {
    String actualTransformedByline =
        bylineTransformer.transform(originalByline, TRANSACTION_ID, TransformationMode.PUBLISH);
