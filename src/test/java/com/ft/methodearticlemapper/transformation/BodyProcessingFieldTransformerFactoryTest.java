...
public class BodyProcessingFieldTransformerFactoryTest {
  ...
  private static final List<String> INTERACTIVE_GRAPHICS_URLS =
      Arrays.asList(
  ...
  // This is our thorough test of a complicated article that can be created in Methode. Has all the
  // special characters and components. Do not remove!
  @Test
  ...
  public void pullQuotesShouldBeReplacedWithAppropriateTags() {
    String pullQuoteFromMethode =
        "<body><p>patelka</p><web-pull-quote align=\"left\" channel=\"FTcom\">&lt;\n"
    ...
    String processedPullQuote =
        "<body><p>patelka</p><pull-quote>"
  ...
  public void pullQuotesWrittenOutsidePtags() {
    String pullQuoteFromMethode =
        "<body><p>patelka</p><p><web-pull-quote align=\"left\" channel=\"FTcom\">&lt;\n"
            + "\t<table align=\"left\" cellpadding=\"6px\" width=\"170px\">\n"
            + "\t\t<tr>\n"
            + "\t\t\t<td>\n"
            + "\t\t\t\t<web-pull-quote-text>\n"
  ...
  public void bigNumbersShouldBeReplacedWithAppopriateTags() {
    String bigNumberFromMethode =
        "<body><p>patelka</p><promo-box class=\"numbers-component\" align=\"right\">"
    ...
    String processedBigNumber =
        "<body><p>patelka</p><big-number>"
  ...
  public void nonClassNumbersComponentIsPromoBoxAndImagePreservedIfPresent() {
    String promoBoxFromMethode =
        "<body><p>This is the beginning of a sentence.<promo-box align=\"left\">"
    ...
    String processedPromoBox =
        "<body><promo-box><promo-title><p>"
  ...
  public void nonClassNumbersComponentIsPromoBoxAndTitleRemovedIfDummyText() {
    String promoBoxFromMethode =
        "<body><p>This is the beginning of a sentence.<promo-box align=\"right\" channel=\"FTcom\"><table width=\"156px\" align=\"right\" cellpadding=\"4px\"><tr><td align=\"left\"><promo-title><p><?EM-dummyText Sidebar title ?>\n"
            + "</p>\n"
            + "</promo-title>\n"
            + "</td>\n"
            + "</tr>\n"
  ...
  public void nonClassNumbersComponentIsOmittedIfNoValuesPresent() {
    String promoBoxFromMethode =
        "<body><p>patelka</p><promo-box align=\"left\">"
            + "<table align=\"left\" cellpadding=\"6px\" width=\"170px\"><tr><td>"
  ...
  public void shouldTransformDataTableWithDifferentFormatting() {
    String dataTableFromMethode =
        "<body><div><web-table><table class=\"data-table\" width=\"100%\"><caption>Table (Falcon Style)</caption>\n"
    ...
    String processedDataTable =
        "<body><table class=\"data-table\"><caption>Table (Falcon Style)</caption>\n"
            + "<thead><tr><th>Column A</th>\n"
            + "<th>Column B</th>\n"
  ...
  public void shouldTransformDataTable() {
    String dataTableFromMethode =
        "<body><div><table class=\"data-table\" border=\"\" cellspacing=\"\" cellpadding=\"\" "
    ...
    String processedDataTable =
        "<body><table class=\"data-table\" id=\"U1817116616509jH\">"
  ...
  public void shouldTransformDataTableInsideOfPTags() {
    String dataTableFromMethode =
        "<body><p>The following data table"
    ...
    String processedDataTable =
        "<body><p>The following data table</p>"
  ...
  public void shouldNotTransformTable() {
    String tableFromMethode =
        "<body><div><table class=\"pseudo-data-table\" border=\"\" cellspacing=\"\" cellpadding=\"\" "
            + "id=\"U1817116616509jH\" width=\"100%\"><caption id=\"k63G\"><span id=\"U181711661650mIC\">KarCrash Q1  02/2014- period from to 09/2014</span>\n"
            + "</caption>\n"
            + "<tr><th width=\"25%\">Sales</th>\n"
            + "<th width=\"25%\">Net profit</th>\n"
  ...
  public void promoBoxWithPromoTitleThatIsEmptyIsBigNumber() {
    String bigNumberFromMethode =
        "<body><p>patelka</p><p><promo-box class=\"numbers-component\" align=\"left\">&lt;<table width=\"170px\" align=\"left\" cellpadding=\"6px\"><tr><td><promo-title>"
            + "</promo-title>\n"
            + "</td>\n"
            + "</tr>\n"
  ...
  public void slideshowShouldBeConvertedToPointToSlideshowOnWebsite() {
    String slideshowFromMethode =
        "<body><p>Embedded Slideshow</p>"
  ...
  public void shouldProcessPodcastsCorrectly() {
    String podcastFromMethode =
        "<body><script type=\"text/javascript\" src=\"http://podcast.ft.com/embed.js\">\n"
            ...
            + "</script></body>";
    String processedPodcast =
        "<body><a data-asset-type=\"podcast\" data-embedded=\"true\" href=\"http://podcast.ft.com/p/2463\" title=\"Golden Flannel of the year award\"></a></body>";
  ...
  public void shouldProcessMultiplePodcastsCorrectly() {
    String podcastFromMethode =
        "<body><script type=\"text/javascript\" src=\"http://podcast.ft.com/embed.js\">\n"
            ...
            + "</script></body>";
    String processedPodcast =
        "<body><a data-asset-type=\"podcast\" data-embedded=\"true\" href=\"http://podcast.ft.com/p/2463\" title=\"Golden Flannel of the year award\"></a>"
  ...
  public void brightcove_shouldProcessVideoTagCorrectly() {
    String videoTextfromMethode =
        "<body>"
            ...
            + "</videoPlayer>"
            + "</body>";
    String processedVideoText =
        "<body><content id=\"28533356-911a-3352-a3cf-06f688157c58\" data-embedded=\"true\" type=\"http://www.ft.com/ontology/content/Video\"></content></body>";
  ...
  public void brightcove_shouldFallbackWhenVideoTagErrors() {
    String videoTextfromMethode =
        "<body><videoPlayer><web-inline-picture id=\"U2113113643377jlC\" width=\"150\" fileref=\"/FT/Graphics/Online/Z_Undefined/FT-video-story.jpg?uuid=91b39ae8-ccff-11e1-92c1-00144feabdc0\" tmx=\"150 100 150 100\"/>\n"
            + "</videoPlayer></body>";
  ...
  public void brightcove_shouldFallbackWhenVideoTagErrors2() {
    String videoTextfromMethode =
        "<body><videoPlayer videoID=\"\"><web-inline-picture id=\"U2113113643377jlC\" width=\"150\" fileref=\"/FT/Graphics/Online/Z_Undefined/FT-video-story.jpg?uuid=91b39ae8-ccff-11e1-92c1-00144feabdc0\" tmx=\"150 100 150 100\"/>\n"
            + "</videoPlayer></body>";
    String processedVideoText = "<body></body>";
    checkTransformation(videoTextfromMethode, processedVideoText);
  }
  ...
  public void shouldProcessVimeoTagCorrectly() {
    String videoTextfromMethode =
        "<body><p align=\"left\" channel=\"FTcom\">Vimeo Video<iframe height=\"245\" frameborder=\"0\" allowfullscreen=\"\" src=\"http://player.vimeo.com/video/77761436\" width=\"600\"></iframe></p></body>";
    String processedVideoText =
        "<body><p>Vimeo Video<a href=\"https://www.vimeo.com/77761436\" data-embedded=\"true\" data-asset-type=\"video\"></a></p></body>";
  ...
  public void shouldProcessVimeoTagWithNoProtocolCorrectly() {
    String videoTextfromMethode =
        "<body><p align=\"left\" channel=\"FTcom\">Vimeo Video<iframe height=\"245\" frameborder=\"0\" allowfullscreen=\"\" src=\"//player.vimeo.com/video/77761436\" width=\"600\"></iframe></p></body>";
    String processedVideoText =
        "<body><p>Vimeo Video<a href=\"https://www.vimeo.com/77761436\" data-embedded=\"true\" data-asset-type=\"video\"></a></p></body>";
    when(videoMatcher.filterVideo(any(RichContentItem.class))).thenReturn(exampleVimeoVideo);
    checkTransformation(videoTextfromMethode, processedVideoText);
  ...
  public void shouldProcessYouTubeVideoCorrectly_withPChannel() {
    String videoTextfromMethode =
        "<body><p align=\"left\" channel=\"FTcom\">Youtube Video<iframe height=\"245\" frameborder=\"0\" allowfullscreen=\"\" src=\"http://www.youtube.com/embed/OTT5dQcarl0\" width=\"600\"></iframe></p></body>";
    String processedVideoText =
        "<body><p>Youtube Video<a href=\"https://www.youtube.com/watch?v=OTT5dQcarl0\" data-embedded=\"true\" data-asset-type=\"video\"></a></p></body>";
  ...
  public void shouldProcessYouTubeVideoCorrectly_withNoPChannel() {
    String videoTextfromMethode =
        "<body><p>Youtube Video<iframe height=\"245\" frameborder=\"0\" allowfullscreen=\"\" src=\"http://www.youtube.com/embed/OTT5dQcarl0\" width=\"600\"></iframe></p></body>";
    String processedVideoText =
        "<body><p>Youtube Video<a href=\"https://www.youtube.com/watch?v=OTT5dQcarl0\" data-embedded=\"true\" data-asset-type=\"video\"></a></p></body>";
    when(videoMatcher.filterVideo(any(RichContentItem.class))).thenReturn(exampleYouTubeVideo);
    checkTransformation(videoTextfromMethode, processedVideoText);
  ...
  public void shouldProcessYouTubeVideoWithHttpsCorrectly() {
    String videoTextfromMethode =
        "<body><p align=\"left\" channel=\"FTcom\">Youtube Video<iframe height=\"245\" frameborder=\"0\" allowfullscreen=\"\" src=\"https://www.youtube.com/embed/OTT5dQcarl0\" width=\"600\"></iframe></p></body>";
    String processedVideoText =
        "<body><p>Youtube Video<a href=\"https://www.youtube.com/watch?v=OTT5dQcarl0\" data-embedded=\"true\" data-asset-type=\"video\"></a></p></body>";
    when(videoMatcher.filterVideo(any(RichContentItem.class))).thenReturn(exampleYouTubeVideo);
    checkTransformation(videoTextfromMethode, processedVideoText);
  ...
  public void shouldProcessInteractiveGraphics() {
    ...
    for (final String url : INTERACTIVE_GRAPHICS_URLS) {
      final String nativeText =
          "<body><p>The table below:</p><p><iframe allowTransparency=\"true\" frameborder=\"0\" scrolling=\"no\" src=\""
              + url
              + "\"/></p></body>";
      final String processedText =
          "<body><p>The table below:</p><p><a data-asset-type=\"interactive-graphic\" href=\""
              + url
              + "\"></a></p></body>";
  ...
  public void shouldProcessInteractiveGraphicsWidthAndHeight() {
    final String nativeText =
        "<body><p>The table below:</p><p><iframe allowTransparency=\"true\" frameborder=\"0\" height=\"670\" scrolling=\"no\" src=\"http://www.ft.com/ig/widgets/profiles-tiled-layout/1.1.0/index.html?id=0AnE0wMr-SY-LdENVcHdXNDI5dkFKV1FicnZ0RUMweXc\" width=\"980\"/></p></body>";
    final String processedText =
        "<body><p>The table below:</p><p><a data-asset-type=\"interactive-graphic\" href=\"http://www.ft.com/ig/widgets/profiles-tiled-layout/1.1.0/index.html?id=0AnE0wMr-SY-LdENVcHdXNDI5dkFKV1FicnZ0RUMweXc\" data-width=\"980\" data-height=\"670\"></a></p></body>";
    when(interactiveGraphicsMatcher.matches(anyString())).thenReturn(true);
    checkTransformation(nativeText, processedText);
  }
  ...
  public void shouldNotProcessOtherIframes() {
    String videoTextfromMethode =
        "<body><p align=\"left\" channel=\"FTcom\"><iframe height=\"245\" frameborder=\"0\" allowfullscreen=\"\" src=\"http://www.bbc.co.uk/video/OTT5dQcarl0\" width=\"600\"></iframe></p></body>";
    String processedVideoText = "<body></body>";
    checkTransformation(videoTextfromMethode, processedVideoText);
  }
  ...
  public void shouldNotProcessOtherIframes_withTextInbetween() {
    String videoTextfromMethode =
        "<body><p channel=\"FTcom\">Video<iframe height=\"245\" frameborder=\"0\" allowfullscreen=\"\" src=\"http://www.notyoutube.com/junk\" width=\"600\"></iframe></p></body>";
  ...
  public void shouldNotProcessOtherScriptTags() {
    String podcastFromMethode =
        "<body><script type=\"text/javascript\">/* <![CDATA[ */window.onload=function(){alert('Something!')}/* ]]> */\n"
            + "\"</script></body>";
  ...
  public void shouldNotProcessOtherScriptTags2() {
    String podcastFromMethode =
        "<body><script type=\"text/javascript\" src=\"http://someStyleSheet\"></script></body>";
    String processedPodcast = "<body></body>";
    checkTransformation(podcastFromMethode, processedPodcast);
  }
  ...
  public void removeEmptyParagraphs() {
    String expectedSentence =
        String.format(
            "<body><p>This one is not empty</p>"
                + "<p>This should not be removed <br/></p></body>");
    checkTransformation(
        "<body><p>This one is not empty</p><p>This should not be removed <br/></p><p><br/></p><p> <br/> </p></body>",
        expectedSentence);
  }

  @Test
  public void shouldTransformSubheadIntoH3ClassFtSubhead() {
    String subheadFromMethode =
        "<body><p>his is some normal text.</p><p>More text</p><subhead>This is a subhead.</subhead><p>This is some more normal text.</p><subhead>This is another subhead.</subhead></body>";
    String processedSubhead =
        "<body><p>his is some normal text.</p><p>More text</p><h3 class=\"ft-subhead\">This is a subhead.</h3><p>This is some more normal text.</p><h3 class=\"ft-subhead\">This is another subhead.</h3></body>";
  ...
  public void shouldRemoveElementsAndContentWithChannelAttributeThatAreStrikeouts() {
    String contentWithStrikeouts =
        "<body><b channel=\"Financial Times\">Should be removed</b><b>Should Stay</b><p channel=\"!Strikeout\">Should be removed</p><p>Text inside normal p tag should remain</p></body>";
    String transformedContent =
        "<body><strong>Should Stay</strong><p>Text inside normal p tag should remain</p></body>";
  ...
  public void shouldRetainElementsAndContentWithChannelAttributesThatAreNotStrikeouts() {
    String contentWithStrikeouts =
        "<body><p channel=\"FTcom\">Random Text<iframe src=\"http://www.youtube.com/embed/OTT5dQcarl0\"></iframe></p><b channel=\"!Financial Times\">Not Financial Times</b></body>";
    String transformedContent =
        "<body><p>Random Text<a href=\"https://www.youtube.com/watch?v=OTT5dQcarl0\" data-asset-type=\"video\" data-embedded=\"true\"/></p><strong>Not Financial Times</strong></body>";
    when(videoMatcher.filterVideo(any(RichContentItem.class))).thenReturn(exampleYouTubeVideo);
    checkTransformation(contentWithStrikeouts, transformedContent);
  }
  ...
  public void testShouldRetainImgTagAndValidAttributes() throws Exception {
    String contentExternalImage =
        "<body><img src=\"someImage.jpg\" alt=\"someAltText\" width=\"200\" height=\"200\" align=\"left\"/></body>";
    String transformedContent =
        "<body><img src=\"someImage.jpg\" alt=\"someAltText\" width=\"200\" height=\"200\"/></body>";
  ...
  public void shouldStripAllAnnotationTagsFromContent() throws Exception {
    String contentWithAnnotation =
        "<body><p>This is <annotation c=\"roddamm\" cd=\"20150224170716\">A new annotation </annotation>annotated</p></body>";
  ...
  public void shouldStripAllNotesFromContent() throws Exception {
    String contentWithNotes =
        "<body><p><span class=\"@notes\">Test notes</span>This text should remain</p></body>";
  ...
  public void shouldUseArticleUuidAndImageSetId() throws Exception {
    ...
    final UUID firstImageSetUuid =
        GenerateV3UUID.singleDigested(articleUuid + FIRST_EMBEDDED_IMAGE_SET_ID);
    final UUID secondImageSetUuid =
        GenerateV3UUID.singleDigested(articleUuid + SECOND_EMBEDDED_IMAGE_SET_ID);
  ...
  public void shouldKeepCiteTagInsideBlockquote() {
    String originalContent =
        "<body><blockquote><p>Quoted text</p><cite>Cite text</cite></blockquote></body>";
    String transformedContent =
        "<body><blockquote><p>Quoted text</p><cite>Cite text</cite></blockquote></body>";
    checkTransformation(originalContent, transformedContent);
  }
  ...
  public void shouldKeepAsideTag() {
    String originalContent =
        "<body><aside><h4>Epcot Center</h4><p>The Epcot Center is a theme park in Disney World, Florida.</p></aside></body>";
    String transformedContent =
        "<body><aside><h4>Epcot Center</h4><p>The Epcot Center is a theme park in Disney World, Florida.</p></aside></body>";
    checkTransformation(originalContent, transformedContent);
  }
  ...
  public void shouldRemoveCiteTagOutsideBlockquote() {
    String originalContent =
        "<body><blockquote><p>Quoted text</p></blockquote><cite>Cite text</cite></body>";
    String transformedContent = "<body><blockquote><p>Quoted text</p></blockquote></body>";
    checkTransformation(originalContent, transformedContent);
  }
  ...
  public void shouldRemoveEmptyParagraphFromBlockquote() {
    String originalContent =
        "<body><blockquote><p></p><p>Quoted text</p><cite>Cite text</cite></blockquote></body>";
    String transformedContent =
        "<body><blockquote><p>Quoted text</p><cite>Cite text</cite></blockquote></body>";
    checkTransformation(originalContent, transformedContent);
  }
  ...
  public void shouldRemoveDummyTextParagraphFromBlockquote() {
    String originalContent =
        "<body><blockquote><p><?EM-dummyText [Quote]?></p><p>Quoted text</p><cite>Cite text</cite></blockquote></body>";
    String transformedContent =
        "<body><blockquote><p>Quoted text</p><cite>Cite text</cite></blockquote></body>";
    checkTransformation(originalContent, transformedContent);
  }
  ...
  public void shouldRemoveEmptyCiteFromBlockquote() {
    String originalContent =
        "<body><blockquote><p>Quoted text</p><cite></cite></blockquote></body>";
    String transformedContent = "<body><blockquote><p>Quoted text</p></blockquote></body>";
    checkTransformation(originalContent, transformedContent);
  }
  ...
  public void shouldRemoveDummyTextCiteFromBlockquote() {
    String originalContent =
        "<body><blockquote><p>Quoted text</p><cite><?EM-dummyText [Quote]?></cite></blockquote></body>";
    String transformedContent = "<body><blockquote><p>Quoted text</p></blockquote></body>";
    checkTransformation(originalContent, transformedContent);
  }
  ...
  public void thatImagesAreExtractedFromParagraphs() {
    ...
    String inlineImageUuid =
        DeriveUUID.with(IMAGE_SET).from(UUID.fromString(webInlinePictureUuid)).toString();

    String originalContent =
        "<body>"
            + "<p><image-set id=\""
            + imageSetId
            + "\"><image-small/><image-medium/><image-large/></image-set></p>"
            + "<p><web-inline-picture fileref=\"/FT/Graphics/Online/Charts/2018/03/Italy_elections_provisional_results-column_chart-ft-web-thememed-700x500-1520234395_20180305071956.png?uuid="
            + webInlinePictureUuid
            + "\" id=\"U32511615782384khF\"/></p>"
            + "<p><img src=\"img1\"/></p>"
    ...
    String transformedContent =
        "<body>"
            + "<ft-content data-embedded=\"true\" type=\"http://www.ft.com/ontology/content/ImageSet\" url=\"http://test.api.ft.com/content/"
            + generatedUuid
            + "\"></ft-content>"
            + "<content data-embedded=\"true\" id=\""
            + inlineImageUuid
            + "\" type=\"http://www.ft.com/ontology/content/ImageSet\"></content>"
            + "<img src=\"img1\"/>"
            + "<img src=\"img2\"/>"
            + "<p>Lorem ipsum</p>"
            + "<img src=\"img3\"/>"
  ...
  public void shouldRemoveEmptyElementsInsideParagraph() {
    String originalContent =
        "<body>"
            ...
            + "</body>";
    String transformedContent =
        "<body>" + "<p> lorem ipsum</p>" + "<p>doler sit amet</p>" + "</body>";
    checkTransformation(originalContent, transformedContent);
  }
  ...
  public void shouldRemoveMarketDataTag() {
    String originalContent =
        "<body><p>Here we are talking about some company and we're going to refer to their stock price</p><marketdata figicode=\"somefigicode\" startdata=\"some date\" live-until=\"publish date plus 1 week\"/><p>blah blah blah</p></body>";
    String transformedContent =
        "<body><p>Here we are talking about some company and we're going to refer to their stock price</p><p>blah blah blah</p></body>";
  ...
  public void shouldRemovePodcastPromoTag() {
    String originalContent =
        "<body><p>Here follows some audio podcast</p><podcast-promo id=\"16ec6a72-d5db-4322-96c6-314b051eb978\"><h2>This is the podcast title</h2><p>This is the podcast description</p></podcast-promo><p>blah blah blah</p></body>";
    String transformedContent =
        "<body><p>Here follows some audio podcast</p><p>blah blah blah</p></body>";
  ...
  public void shouldTransformDynamicContent() {
    String dynamicContent =
        "<body><p>Embedded Dynamic Content</p>"
            ...
            + "</p></body>";
    String processedDynamicContent =
        "<body><p>Embedded Dynamic Content</p>"
    ...
    checkTransformation(
        dynamicContent, processedDynamicContent, Maps.immutableEntry("apiHost", "test.api.ft.com"));
  }

  @Test
  public void shouldExtractDynamicContentFromParagraphs() {
    String dynamicContent =
        "<body><p>Embedded Dynamic Content</p><p>"
  ...
  private void checkTransformation(
    ...
    checkTransformation(
        originalBody, expectedTransformedBody, TransformationMode.PUBLISH, contextData);
  }
  ...
  private void checkTransformation(
      ...
      Map.Entry<String, Object>... contextData) {
    String actualTransformedBody =
        bodyTransformer.transform(originalBody, TRANSACTION_ID, mode, contextData);
  ...
  private void checkTransformationToEmpty(String originalBody) {
    String actualTransformedBody =
        bodyTransformer.transform(originalBody, TRANSACTION_ID, TransformationMode.PUBLISH);
  ...
  private String readFromFile(String resourceName) {
    ...
    try {
      bodyFromFile =
          Resources.toString(
              BodyProcessingFieldTransformerFactoryTest.class.getResource(resourceName),
              Charsets.UTF_8);

      // because what we get back from the API uses UNIX line encodings, but when working locally on
      // Windows, the expected file will have \r\n
