...
public class RemoteServiceHealthCheckTest {
  ...
  public void setUp() throws Exception {
    ...
    URI goodToGoUri = UriBuilder.fromPath("__gtg").scheme("http").host(HOST).port(PORT).build();
  ...
  public void testWhenUppServiceIsDownHealthCheckShouldFail() throws Exception {
    ...
    AdvancedResult expectedHealthCheckResult =
        AdvancedResult.error(healthCheck, "Methode api ping: Exception during ping, timeout");
    AdvancedResult actualHealthCheckResult = healthCheck.checkAdvanced();
